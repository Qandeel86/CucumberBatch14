...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void added_employee_is_displayed_in_database() {
        ...
        List<Map<String, String>> dataFromDatabase=DBUtility.getListOfMapsFromRset(DatabaseSteps.getFnameLnameQuery()+id);
